...
namespace Sort.Business
{
    public class SubjectCategoryObject
    {
        ...
        public static SubjectCategoryObject GetSubjectCategory(int subjectCategoryId) => repo.GetSubjectCategory(subjectCategoryId);
        ...
        {
            MemoryCache.ClearSubjectCategories();
            return repo.DeleteSubjectCategory(this);
        }
