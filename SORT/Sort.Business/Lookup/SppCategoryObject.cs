...
namespace Sort.Business
{
    public class SppCategoryObject
    {
        ...
        public static List<SppCategoryObject> GetSppCategories() => repo.GetSppCategories();

        public static SppCategoryObject GetSppCategory(int sppCategoryId) => repo.GetSppCategory(sppCategoryId);
