...
namespace LRS.EmployeeHelper.Controllers
{
    public class HelperController : Controller
    {
        ...
        {
            return getFile($"LRS.EmployeeHelper.Dependencies.Css.{file}");
        }

        [OutputCache(Duration = 3600, VaryByParam = "file")]
        public ActionResult Script(string file)
        {
            return getFile($"LRS.EmployeeHelper.Dependencies.Script.{file}");
        }
