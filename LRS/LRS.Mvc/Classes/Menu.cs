...
namespace LRS.Mvc.Classes
{
    public static class Menu
    {
		private static List<MenuItem> baseMenu = new List<MenuItem>() {
		    ...
		    new MenuItem() { Text = "Reports", Icon = "line-chart", Controller = "Report", SubMenuItems = new List<MenuItem>() {
		        new MenuItem() { Text = "AdHoc", Action = "Index", Icon = "line-chart" },
                new MenuItem() {Text =  "Org Review Numbers", Action = "OrgReviewReport", Icon = "sitemap", Roles = "Admin,ReleaseOfficial,GenericReleaseUser"},
                new MenuItem() {Text =  "Pending Reviews", Action = "PendingReviews", Icon = "users", Roles = "Admin,ReleaseOfficial"},
		    }},
            new MenuItem() { Text = "Admin", Controller = "Admin", Roles = "Admin", SubMenuItems = new List<MenuItem>() {
                ...
                new MenuItem() {Text =  "Outstanding Reviews", Action = "OutstandingReviews", Icon = "envelope"}
            }},
		    new MenuItem() { Text = "SORT Website", Icon = "globe", Controller = "Edms", Action = "SortHome"}
        };
