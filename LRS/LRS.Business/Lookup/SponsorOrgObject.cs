...
namespace LRS.Business
{
    public class SponsorOrgObject
    {
        ...
        internal static List<SponsorOrgObject> GetSponsorOrgs() => repo.GetSponsorOrgs();

        internal static SponsorOrgObject GetSponsorOrg(int sponsorOrgId) => repo.GetSponsorOrg(sponsorOrgId);
